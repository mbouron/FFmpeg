...
#ifndef FF_MEDIACODEC_H
#define FF_MEDIACODEC_H
 ...
 * ff_AMediaCodec_infoOutputFormatChanged and ff_AMediaCodec_cleanOutputBuffers
 * are not part of the original NDK API and are convenience functions to hide
 * JNI implementation.
 *
...
enum {
    FF_AMEDIACODEC_BUFFER_FLAG_END_OF_STREAM = 4,
    FF_AMEDIACODEC_CONFIGURE_FLAG_ENCODE = 1,
    FF_AMEDIACODEC_INFO_OUTPUT_BUFFERS_CHANGED = -3,
    FF_AMEDIACODEC_INFO_OUTPUT_FORMAT_CHANGED = -2,
    FF_AMEDIACODEC_INFO_TRY_AGAIN_LATER = -1
};
